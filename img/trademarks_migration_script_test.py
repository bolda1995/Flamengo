...
DESTINATION_DIRECTORY = 'C:\\astz_images\\'
NFS = '/mnt/nfs/data/datamart/'
CONSOLE_HANDLER = logging.StreamHandler()
LOG_HANDLER = RotatingFileHandler(
    'trademark_logs\\{}.log'.format(datetime.datetime.now().strftime("%Y-%m-%d_%H-%M")),
...
@time_test
def get_storage_obj(connection, cursor, received_date, parent_number=None):
...
@time_test
def get_record_dict(dictionary):
    record_dictionary = {}
...
def delete_commas(start_string):
...
@time_test
def create_rutrademark(CONNECTION, CURSOR, record_dictionary, root_object_uuid, rutmk_uid_value, update_time, NULL_VALUE):
...
def create_rutmkpriority(CONNECTION, CURSOR, record_dictionary, rutmk_uid_value, priority_type, priority_date, priority_appl_number, priority_appl_date):
...
def create_correspondenceaddress(CONNECTION, CURSOR, record_dictionary, address_uid_value, update_time):
    values_list = [
...
def create_rutmkcorrespondenceaddress(CONNECTION, CURSOR, record_dictionary, rutmk_uid_value, address_uid_value):
...
def create_rutmkgoodsservices(CONNECTION, CURSOR, record_dictionary, rutmk_uid_value, class_number, class_definition):
...
def create_contact(CONNECTION, CURSOR, record_dictionary, update_time, contact_uid_value, mode=None):
    values_list = [
...
def create_rutmkapplicant(CONNECTION, CURSOR, contact_uid, rutmk_uid, record_dictionary):
...
def create_rutmkholder(CONNECTION, CURSOR, contact_uid, rutmk_uid, record_dictionary):
...
def create_rutmkrepresentative(CONNECTION, CURSOR, contact_uid, rutmk_uid, record_dictionary):
...
def create_contactaddress(CONNECTION, CURSOR, contact_uid_value, record_dictionary, update_time, mode=None):
